;;; packages.el --- iTBoyers layer packages file for Spacemacs.
;;
...
;; added to `iTBoyers-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `iTBoyers/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `iTBoyers/pre-init-PACKAGE' and/or
;;   `iTBoyers/post-init-PACKAGE' to customize the package as it is loaded.
